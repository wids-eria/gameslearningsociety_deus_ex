...
<head>
    ...
    <script type="text/javascript">try{Typekit.load();}catch(e){}</script>
		 ...
		 <!-- Run Flash Player -->
        <script language="JavasScript" type="text/javascript" src="builds/citizen_science/AC_RunActiveContent.js"></script>
...
<div class="body_content_container">
    ...
    <div class="body_content">
        ...
        <div class="unity_embed_container_cs">
            <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                ...
                <EMBED src="builds/citizen_science/Main.swf"
