...
<div class="body_content_container">
    ...
    <div class="body_content">
        ...
        <div class="full_width floatright topmargin">
            ...
            <p class="subhead_type floatleft">Current Courses</p>
            
            <div class="hp_courses_containter floatleft">
                
                <!-- A1 -->
                    <div class="hp_course_link">
                        <a href="http://public.my.wisc.edu/portal/f/u124l1s4/p/CourseGuide-Browse-Courses.u124l1n31/detached/render.uP?pCm=view&pP_courseID=023567&pP_subjectId=272&pP_topicId=0&pP_action=courseDetail&pP_termCode=1146"
                        ...
                        <a href="courses_you_play_papers.php" class="course_title">
                ...
                <!-- A3 -->
                    <div class="hp_course_link">
                        <a href="http://public.my.wisc.edu/portal/f/u124l1s4/p/CourseGuide-Browse-Courses.u124l1n31/detached/render.uP?pCm=view&pP_courseID=023712&pP_subjectId=305&pP_topicId=0&pP_action=courseDetail&pP_termCode=1146"
                           target="_blank" title=""><div class="arrow floatright"></div></a>
                ...
                <!-- A5 -->
                    <div class="hp_course_link">
                        <a href="http://public.my.wisc.edu/portal/f/u124l1s4/p/CourseGuide-Browse-Courses.u124l1n31/detached/render.uP?pCm=view&pP_courseID=024100&pP_subjectId=272&pP_topicId=0&pP_action=courseDetail&pP_termCode=1154"
                           target="_blank" title=""><div class="arrow floatright"></div></a>
                        <p class="course_title">C&I 802: Discourse Analysis</p>
                        <p class="course_instructor bold">Professor: Constance Steinkuehler</p>
                ...
                <!-- A6 -->
                    <div class="hp_course_link">
                        ...
                        <ol>
                            <li>Define, understand, and use constructionism to build curricula. </li>
                            <li>Design, build, and modify constructionist media for teaching and education.</li>
                            <li>Examine the core theories, models, and philosophies of constructionism.</li>
                            <li>Relate the course content to his/her career/academic goals.</li>
                        </ol>
                ...
                <!-- A7 -->
                    <div class="hp_course_link">
                        <p class="course_title">Game Communities and Learning</p>
                        <p class="course_instructor bold">Professor: Constance Steinkuehler</p>
                        ...
                        <ol>
                            <li>To educate students in dominant theories of learning related to social interaction</li>
                            <li>to engender careful reflection on how given theories of learning entail specific empirical methods over others, and</li>
                            <li>to give students experience at applying said theories and methods to game based community data. </li>
                        </ol>
                ...
                <!-- A8 -->
                    <div class="hp_course_link">
                        <p class="course_title">C&I 801: Interactive and Multimedia Computers in the Curriculum</p>
                        <p class="course_instructor bold">Professor: Kurt Squire</p>
