...
<div class="floatleft">
	<h2 class="page_label center_text">Proceedings</h2>

	<?php query_posts('category_name=proceeding');?>
	...
	<h2 class="page_label center_text"> Previous Conference Sites</h2>
		<?php query_posts('category_name=old-site');?>
